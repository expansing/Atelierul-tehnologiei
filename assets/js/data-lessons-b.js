...
},
{
  ...
  explanation: [
    "Ce este: acum legi comenzi mici pentru a rezolva o misiune. Vei folosi fluent cat, grep, find, ps, top, cp, mv, rm și mkdir, dar viteza vine după ce înțelegi ce face fiecare. `cat` afișează conținutul unui fișier text, `grep` selectează rânduri care se potrivesc unui text, `find` caută fișiere după reguli, iar `man` deschide manualul unei comenzi. O comandă bună are o intenție clară: înainte s-o rulezi, spune ce citește și ce rezultat aștepți.",
