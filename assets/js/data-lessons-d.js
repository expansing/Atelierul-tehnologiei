...
},
{
  ...
  explanation: [
    "Un laborator izolat este un mediu de testare separat de datele și rețelele reale. Experimentele de securitate se fac DOAR în medii izolate, niciodată pe sisteme sau conturi ale altora. Mașina virtuală este un calculator simulat în fișier, iar host-only sau Internal Network limitează comunicarea la gazdă și VM-urile aprobate. Adultul verifică setările înainte de orice experiment, pentru că „virtual” nu înseamnă risc zero.",
...
},
{
  ...
  explanation: [
    ...
    "Demo-ul „Bucla de feedback, de la un click” urmărește un singur semnal până la un feed dominat de același subiect. Desenează bucla completă: comportament → date → algoritm → recomandare → comportament, apoi auditează-ți propriul feed ca un cercetător. Experimentul celor două feeduri transformă explicația într-o măsurătoare: notezi zilnic categoriile recomandate și observi cât de repede se schimbă selecția. Auditul final nu condamnă platforma, ci arată cine controlează fiecare parte a buclei și ce reguli personale poți aplica."
  ],
  demo: {
    type: "flow",
...
},
{
  ...
  explanation: [
    ...
    "Demo-ul „Permisiune necesară sau hoție?” exersează potrivirea dintre funcție și acces. Înainte de instalare, întreabă: cine primește datele, de ce le vrea și ce poate face cu ele? În fiecare caz, copilul trebuie să distingă „pot să fac” de „e bine să fac”, fiindcă posibilitatea tehnică nu este automat o decizie etică. Inventarul din laborator transformă principiul într-o acțiune concretă: verifici aplicațiile, marchezi cererile nejustificate și revoci una cu aprobarea adultului. Cartea drepturilor datelor păstrează harta, regulile și planul de urgență, astfel încât o decizie bună să poată fi repetată și după lecție."
  ],
  demo: {
    type: "classify",
...
},
{
  ...
  explanation: [
    ...
    "Demo-ul „Arhitectura asistentului responsabil” arată lanțul de la rol la jurnal, iar experimentul îl testează timp de șapte zile. Proiectează un sistem de asistent AI cu reguli de siguranță și verificare, construiește un instrument de lucru care aplică tot nivelul 11 și prezintă deciziile de design etic luate, explicând de ce. Scopul nu este să prinzi cât mai multe greșeli, ci să măsori când asistentul ajută, când necesită corecție și ce reguli trebuie schimbate. Ghidul final trebuie scris în cuvintele tale și demonstrat pe un caz real, astfel încât altă persoană să poată înțelege și reproduce metoda."
  ],
  demo: {
    type: "flow",
